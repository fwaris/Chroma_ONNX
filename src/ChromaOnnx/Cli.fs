...
module Cli =
    ...
    let printUsage() =
        ...
        printfn "  ChromaOnnx s2s-serve --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --work-dir served_runs --port 5055 --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --thinker-active-frames 0 --stream-decode-frames 8 --stream-min-free-vram-mb 1024 --codec-stall-guard-frames 16 --cuda-gpu-mem-limit-mb 15360 --max-queue-length 32 --max-prompt-audio-seconds 60 --max-turn-audio-seconds 60 --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --python .venv/Scripts/python.exe --python-device cuda"
        printfn "  ChromaOnnx s2s-offline --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --prompt-text text --prompt-audio-f32 reference_24k.f32 --user-audio-f32 turn_16k.f32 --frames 8 --output-dir served_runs/offline/fsharp --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --thinker-active-frames 0 --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --cuda-gpu-mem-limit-mb 15360"
        printfn "  ChromaOnnx s2s-debug-onnx --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --prepared-dir served_runs/debug/prepared --output-dir served_runs/debug/onnx --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --cuda-gpu-mem-limit-mb 15360"
        printfn "  ChromaOnnx s2s-benchmark --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --prompt-text text --prompt-audio-f32 reference_24k.f32 --user-audio-f32 turn_16k.f32 --frames 8 --warmup 1 --iterations 5 --output-dir served_runs/bench/fsharp --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --thinker-active-frames 0 --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --cuda-gpu-mem-limit-mb 15360"
        printfn "  ChromaOnnx s2s-compare --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --prompt-text text --prompt-audio reference.wav --user-audio turn.wav --output-dir served_runs/compare --python .venv/Scripts/python.exe --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --cuda-gpu-mem-limit-mb 15360 [--thinker-active-frames 0]"
        printfn "  ChromaOnnx s2s-memory-report --model-dir models/chroma-4b --bundle-dir onnx_deploy/chroma-s2s-full-v2 --prompt-text text --prompt-audio-f32 reference_24k.f32 --user-audio-f32 turn_16k.f32 --frames 8 --output-dir served_runs/memory --python .venv/Scripts/python.exe --execution-provider cuda --memory-mode resident-merged --ort-memory-profile quality-safe --thinker-active-frames 0 --optimized-model-cache-dir onnx/chroma-s2s-full-v2/ort-cache-ort-local-external --optimized-model-cache-format onnx --cuda-gpu-mem-limit-mb 15360"
    ...
    let s2sOffline args =
        ...
        let systemPrompt = optional "You are Chroma, an advanced virtual human created by the FlashLabs. You possess the ability to understand auditory inputs and generate both text and speech." "--system-prompt" args
